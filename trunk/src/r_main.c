...
void R_InitLightTables (void)
{
	...
	{
//	    scale = FixedDiv ((SCREENWIDTH/2*FRACUNIT), (j+1)<<LIGHTZSHIFT);	// CHANGED FOR HIRES
	    scale = FixedDiv ((ORIGWIDTH/2*FRACUNIT), (j+1)<<LIGHTZSHIFT);	// CHANGED FOR HIRES
...
/*
	...
	viewheight = (setblocks*168/10)&~7;				// CHANGED FOR HIRES
...
*/
	...
	viewheight = ((setblocks*168/10)&~7) << hires;			// CHANGED FOR HIRES
    }

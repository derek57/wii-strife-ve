...
void P_SpawnFireFlicker (sector_t*      sector)
{
    ...
    flick = Z_Malloc ( sizeof(*flick), PU_LEVSPEC, 0, "P_SpawnFireFlicker");
...
void P_SpawnLightFlash (sector_t*	sector)
{
    ...
    flash = Z_Malloc ( sizeof(*flash), PU_LEVSPEC, 0, "P_SpawnLightFlash");
  ...
  int           inSync )
{
    ...
    flash = Z_Malloc ( sizeof(*flash), PU_LEVSPEC, 0, "P_SpawnStrobeFlash");
...
void P_SpawnGlowingLight(sector_t*	sector)
{
    ...
    g = Z_Malloc( sizeof(*g), PU_LEVSPEC, 0, "P_SpawnGlowingLight");

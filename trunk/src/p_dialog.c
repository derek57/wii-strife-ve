...
boolean dialog_active = false;	// FIX FOR THE WII: DISABLES THE JUMPING WHILE USING DIALOG ITEMS
...
void P_DialogDoChoice(int choice)
{
	...
	dialog_active = false;	// FIX FOR THE WII: DISABLES THE JUMPING WHILE USING DIALOG ITEMS
    }
    else

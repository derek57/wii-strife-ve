...
#define ST_HEIGHT	32
/*
#define ST_WIDTH	SCREENWIDTH			// CHANGED FOR HIRES
#define ST_Y		(SCREENHEIGHT - ST_HEIGHT)	// CHANGED FOR HIRES
*/
#define ST_WIDTH	ORIGWIDTH			// CHANGED FOR HIRES
#define ST_Y		(ORIGHEIGHT - ST_HEIGHT)	// CHANGED FOR HIRES

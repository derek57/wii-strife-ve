...
/*
    vis->texturemid = ((BASEYCENTER<<FRACBITS)+FRACUNIT/2)		// CHANGED FOR HIRES
	-(psp->sy-spritetopoffset[lump])				// CHANGED FOR HIRES
        + FixedMul(vis->xiscale, (centery-viewheight/2)<<FRACBITS);	// CHANGED FOR HIRES
*/
    vis->texturemid = ((BASEYCENTER<<FRACBITS)/*+FRACUNIT/2*/)		// CHANGED FOR HIRES
	-(psp->sy-spritetopoffset[lump])				// CHANGED FOR HIRES
        + FixedMul(vis->xiscale, (centery-viewheight/2)<<FRACBITS);	// CHANGED FOR HIRES

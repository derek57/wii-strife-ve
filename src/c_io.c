...
//    byte *oldscreen;
    ...
    if(backdrop)
	Z_Free(backdrop, "C_InitBackdrop");

    backdrop = Z_Malloc(SCREENWIDTH * SCREENHEIGHT, PU_STATIC, 0, "C_InitBackdrop");
...
*/
    memcpy(I_VideoBuffer, backdrop + (400 - (current_height * 4)) * 320, ((current_height * 4)) * 320);
}

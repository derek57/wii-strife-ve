...
//extern musicinfo_t	S_music[];		// FOR PSP: (SHAREWARE RESTRICTIONS)

extern musicinfo_t	S_musicDemo[];		// FOR PSP: (SHAREWARE RESTRICTIONS)
extern musicinfo_t	S_musicFull[];		// FOR PSP: (SHAREWARE RESTRICTIONS)
